...
const ProfilePage = () => {
 ...
 const handleSubmit = async (e)=> {
  ...
  return (
    <div className='min-h-screen bg-no-repeat flex items-center
    justify-center'>
      <div className='w-5/6 max-w-2xl backface-blur-2xl text-gray-300 border-2
      ...
      rounded-lg'>
        ...
        <img src={assets.logo_icon}
         alt="" className={`max-w-44 aspect-square rounded-full mx-10 max-sm:mt-10 ${
