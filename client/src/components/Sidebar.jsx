    ...
    text-white ${selectedUser ? "max-md:hidden" : ''}`}>
       <div className='pb-5'>
           <div className='flex justify-between items-center'>
             <img scr={assets.logo}  alt="logo" className='max-w-40'/>
             <div className='relative py-2 group'>
                    ...
                    group-hover:block'>
                      <p className='cursonr-pointer text-sm' onClick={() => navigate('/profile')}>Edit Profile</p>
                  ...
                  cursor-pointer max-sm:text-sm ${selectedUser?._id === user._id && 
                    'bg-[#282142]/50' }`}>
                      ...
                      <div className='flex flex-col leading-5'>
                             ...
                             {
                                 index < 3 
                                 ? <span className='text-green-400 tex-xs'>Online</span>
